...
<html>
	...
	<body bgcolor = "#FFFFFF">
		<div style = "width: 930px; height: 1130px; border: solid 1px #333333; ">
         <div>
			<div style="width: 930px; height: 1050px;">
			...
			<br />
				...
				<form action="./report_menu.html">
					<input type="submit" value="Go Back" style="float: right; margin: 30px">
				</form>
         </div>
