	...
	<body bgcolor = "#FFFFFF">
		<div>
         <div style = "width:600px; border: solid 1px #333333; ">
			...
			<center>
			<form action="SubmitCourseToSos.php" method="post">
				<?php
					...
					echo "</tr>";
						...
						//echo "<td><form action='SubmitCourseToSos.php.php' method='post'><input type='hidden' name='tempid' value='".$id."'/><input type='submit' name='submit-btn' value='edit' /></form></td></tr>";
						}
					echo "</table>";
				?>
				</center>
				</br>
				<input type ="hidden" value="<?php echo $TempId; ?>" name="TempID" style = "float:center">
