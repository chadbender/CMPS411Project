         ...
         <div style = "width:600px; border: solid 1px #333333; ">
            ...
            <div style = "margin:30px">
				...
				<form method="post">
					...
					<input type="submit" value="Edit/Add/Delete" style = "float:center" formaction="DataTable.php">
					<br />
					<br />
					<input type="submit" value="Generate base Rubric" style = "float:right" formaction="RunAppend.php">						
					<input type="submit" value="Go Back" style = "float:left" formaction="./ReportMenu.html">
					<br />
